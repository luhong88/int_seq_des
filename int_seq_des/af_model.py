# This is a modified version of colabdesign/af/model.py (version 1.1.1)
# We pull the haiku data loading step out of the model initialization step
# to make repeated model init/calls faster
...
def get_af_model_parameters(model_names, data_dir):
    params_list= []
    ...
    return dict(zip(model_names, params_list))
